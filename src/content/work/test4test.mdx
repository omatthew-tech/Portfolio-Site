---
title: "Test4Test: improving reciprocal user testing"
summary: "A platform where startup founders can exchange feedback, iterate quickly and explore new ideas."
...
<CaseText align="center" heading="The Start">
  With Codex, I quickly made a simple usability platform where users can submit
  their app, whether it is a website, iOS app, or Android app, and add survey
  questions that are AI-generated, custom, or general. I also included a survey
  to understand how users felt about the process.
</CaseText>
